...
class AESECBHelper:
    def __init__(self, api_key):
        ...
        # NIST AES-ECB 测试向量（AES Known Answer Test, KAT）
        self.test_vectors = [
            {
                "name": "NIST ECBGFSbox 128 #1",
                "key": "00000000000000000000000000000000",
                "plaintext": "f34481ec3cc627bacd5dc3fb08f273e6",
                "expected_ciphertext": "0336763e966d92595a567cc9ce537f5e"
            },
            {
                "name": "NIST ECBGFSbox 128 #2",
                "key": "00000000000000000000000000000000",
                "plaintext": "9798c4640bad75c7c3227db910174e72",
                "expected_ciphertext": "a9a1631bf4996954ebc093957b234589"
            }
        ]

    @retry(stop_max_attempt_number=3, wait_fixed=2000)
    def _generate_c_code(self):
        """生成符合NIST AES-ECB标准的C代码"""
